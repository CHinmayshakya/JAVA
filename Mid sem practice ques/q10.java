...
class calculation extends customer{
    ...
    void display(){
        System.out.println("name =" + name + "branch = "+branch+"address = "+addr+"IFScode = "+ifcode);
        System.out.println("name =" + cname + "address = "+addr+"contact = "+contact+"balance = "+bal);
